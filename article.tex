...
g & 0 \\
0 & g
\end{pmatrix} \sigma^{-1}$ avec $X \in M_n$ et $g \in G_n$. L'élément $\sigma$ est la matrice associée à la permutation $\bigl(\begin{smallmatrix}
...
\begin{theoreme}
Soit $\varphi_1, \varphi_2 \in \mathcal{S}(H_n \backslash G_{2n}, \theta)$. On a l'égalité
\begin{equation}
(\phi_1, \phi_2)_{L^2(H_n \backslash G_{2n})} = \int_{Temp(SO(2n+1))/Stab} (\varphi_1, \varphi_2)_{H_n \backslash G_{2n}, T(\sigma)} \frac{|\gamma^*(0, \sigma, Ad, \psi)|}{|S_\sigma|}d\sigma,
\end{equation}
où $T : Temp(SO(2n+1))/Stab \rightarrow Temp(G_{2n})$ est l'application de transfert, $(\varphi_1, \varphi_2)_{H_n \backslash G_{2n}, T(\sigma)}$ est défini dans le théorème \ref{thPlanch} à partir de la forme linéaire $\beta$.
\end{theoreme}
