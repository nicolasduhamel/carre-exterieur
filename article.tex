...
\begin{theoreme}
Soit $F$ est un corps $p$-adique. Soit $\varphi_1, \varphi_2 \in \mathcal{S}(H_n(F) \backslash GL_{2n}(F), \theta)$. On a l'égalité
\begin{equation}
...
\begin{theoreme}
$F$ est un corps $p$-adique. Une décomposition de Plancherel abstraite sur $L^2(GL_n(F) \times GL_n(F) \backslash GL_{2n}(F))$ est obtenue par la relation
\begin{equation}
